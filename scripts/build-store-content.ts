...
const NL_CURATION: Record<string, Curation> = {
  ...
  "vidaxlnl": { category_slug: "home-garden", geo_scope: "nl", angle: "het online warenhuis voor huis en tuin" },
  ...
  // --- scale-up batch (2026-07-26) ---
  "zooplus-16": { category_slug: "pets", geo_scope: "nl", angle: "de grote online dierenspeciaalzaak" },
  "medpets": { category_slug: "pets", geo_scope: "nl", angle: "de online dierenapotheek" },
  "brekznl": { category_slug: "pets", geo_scope: "nl", angle: "de online dierenwinkel en -apotheek" },
  "auping": { category_slug: "home-garden", geo_scope: "nl", angle: "de Nederlandse beddenfabrikant" },
  "lampenlichtnl": { category_slug: "home-garden", geo_scope: "nl", angle: "de verlichtingsspecialist" },
  "dekbed-discounter-3": { category_slug: "home-garden", geo_scope: "nl", angle: "de beddengoedspecialist" },
  "vonroc": { category_slug: "home-garden", geo_scope: "nl", angle: "de online gereedschapswinkel" },
  "lednl-3": { category_slug: "home-garden", geo_scope: "nl", angle: "de LED-verlichtingsspecialist" },
  "sharkninja-10": { category_slug: "home-garden", geo_scope: "nl", angle: "de specialist in keuken- en huishoudapparaten (Ninja & Shark)" },
  "lego-10": { category_slug: "toys-games", geo_scope: "nl", angle: "de officiële webshop voor de nieuwste bouwsets" },
  "nedgame": { category_slug: "toys-games", geo_scope: "nl", angle: "de games- en consolewinkel" },
  "dreamland-2": { category_slug: "toys-games", geo_scope: "nl", angle: "de speelgoedwinkel" },
  "ziengs": { category_slug: "fashion", geo_scope: "nl", angle: "de schoenenwinkel" },
  "daka": { category_slug: "fashion", geo_scope: "nl", angle: "de sport- en outdoorwinkel" },
  "pme-legend-3": { category_slug: "fashion", geo_scope: "nl", angle: "het herenmodemerk" },
  "sliponlinenl": { category_slug: "fashion", geo_scope: "nl", angle: "de instapper- en schoenenwinkel" },
  "schuurman-schoenen": { category_slug: "fashion", geo_scope: "nl", angle: "de schoenenwinkel" },
  "jeans-centre": { category_slug: "fashion", geo_scope: "nl", angle: "de spijkerbroeken- en modewinkel" },
  "suitableshop": { category_slug: "fashion", geo_scope: "nl", angle: "de herenmode- en pakkenwinkel" },
  "proshop": { category_slug: "tech-electronics", geo_scope: "nl", angle: "de computer- en elektronicawinkel" },
  "printabout": { category_slug: "tech-electronics", geo_scope: "nl", angle: "de printer- en inktspecialist" },
  "inktwebnl": { category_slug: "tech-electronics", geo_scope: "nl", angle: "de inkt- en tonerspecialist" },
  "batterijenhuis": { category_slug: "tech-electronics", geo_scope: "nl", angle: "de batterij- en accuspecialist" },
  "haarshopnl-2": { category_slug: "health-beauty", geo_scope: "nl", angle: "de winkel voor haarverzorging en kappersproducten" },
  "pharmamarket": { category_slug: "health-beauty", geo_scope: "nl", angle: "de online apotheek en drogist" },
  "vision-direct": { category_slug: "health-beauty", geo_scope: "nl", angle: "de online contactlenzenwinkel" },
  "123lens": { category_slug: "health-beauty", geo_scope: "nl", angle: "de contactlenzenwinkel" },
  "luxplus": { category_slug: "health-beauty", geo_scope: "nl", angle: "de voordeelwinkel voor verzorgingsproducten" },
  "trivago": { category_slug: "travel", geo_scope: "nl", angle: "de hotelvergelijker" },
  "voordeeluitjesnl-2": { category_slug: "travel", geo_scope: "nl", angle: "de aanbieder van korte vakanties in Nederland" },
  "skyscanner-12": { category_slug: "travel", geo_scope: "nl", angle: "de vluchtenvergelijker" },
  "simpel": { category_slug: "services", geo_scope: "nl", angle: "de voordelige mobiele provider" },
  "essent": { category_slug: "services", geo_scope: "nl", angle: "de energieleverancier" },
  "braadbaas": { category_slug: "groceries-food", geo_scope: "nl", angle: "de online BBQ- en vleesspecialist" },
  "superfoodstorenl-3": { category_slug: "groceries-food", geo_scope: "nl", angle: "de superfood- en gezondheidswinkel" },
  // --- scale-up batch 2 (2026-07-26) ---
  "the-butchery": { category_slug: "groceries-food", geo_scope: "nl", angle: "de online slagerij en vleesspecialist" },
  "bbquality-2": { category_slug: "groceries-food", geo_scope: "nl", angle: "de premium vlees- en BBQ-slager" },
  "factor": { category_slug: "groceries-food", geo_scope: "nl", angle: "de bezorgdienst voor kant-en-klare maaltijden" },
  "hallmark": { category_slug: "marketplaces", geo_scope: "nl", angle: "de wenskaarten- en cadeauwinkel" },
  "goedkoopste-kantoorartikelennl": { category_slug: "marketplaces", geo_scope: "nl", angle: "de winkel voor voordelige kantoorartikelen" },
  "albelli-5": { category_slug: "services", geo_scope: "nl", angle: "de fotoboeken- en fotoprintservice" },
  "gaslichtcom": { category_slug: "services", geo_scope: "nl", angle: "de energievergelijker" },
  "geldnl": { category_slug: "services", geo_scope: "nl", angle: "de vergelijkingssite voor verzekeringen en geldzaken" },
  "solcon": { category_slug: "services", geo_scope: "nl", angle: "de internetprovider" },
  "pricewise-internet-tv": { category_slug: "services", geo_scope: "nl", angle: "de internet- en tv-vergelijker" },
  "kpn-thuis-2": { category_slug: "services", geo_scope: "nl", angle: "de internet- en tv-abonnementen van KPN" },
  "odido-thuis": { category_slug: "services", geo_scope: "nl", angle: "het thuis-internet van Odido" },
  "energie-van-budget-thuis": { category_slug: "services", geo_scope: "nl", angle: "de voordelige energieleverancier Budget Thuis" },
  "eset": { category_slug: "services", geo_scope: "nl", angle: "de antivirus- en internetbeveiligingssoftware" },
  "prime-video-9": { category_slug: "services", geo_scope: "nl", angle: "de streamingdienst van Amazon" },
  "beltegoednl": { category_slug: "services", geo_scope: "nl", angle: "de beltegoed-oplaaddienst" },
  "philips-persoonlijke-verzorging": { category_slug: "health-beauty", geo_scope: "nl", angle: "het persoonlijke-verzorgingsassortiment van Philips" },
  "pazzoxnl-2": { category_slug: "fashion", geo_scope: "nl", angle: "de mode- en accessoirewinkel" },
  "mango-14": { category_slug: "fashion", geo_scope: "nl", angle: "het internationale modemerk" },
  "jumbo-sports": { category_slug: "fashion", geo_scope: "nl", angle: "de golf- en sportwinkel" },
  "123jaloezie-2": { category_slug: "home-garden", geo_scope: "nl", angle: "de raamdecoratie-specialist" },
  "galaxus-4": { category_slug: "tech-electronics", geo_scope: "nl", angle: "het brede online warenhuis" },
